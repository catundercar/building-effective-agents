...
LABS = [
    {
        "name": "Lab 1: Orchestrator",
        "test_file": "tests/test_lab1_orchestrator.py",
        "source_file": "phase_4/orchestrator.py",
        "color": RED,
    },
    {
        "name": "Lab 2: Evaluator",
        "test_file": "tests/test_lab2_evaluator.py",
        "source_file": "phase_4/evaluator.py",
        "color": YELLOW,
    },
    {
        "name": "Lab 3: Eval Framework",
        "test_file": "tests/test_lab3_eval_framework.py",
        "source_file": "phase_4/eval_framework.py",
        "color": BLUE,
    },
]
...
def main():
    ...
    print(f"{BOLD}{BLUE}║   Phase 4: Orchestration & Evaluation — 評分     ║{RESET}")
    print(f"{BOLD}{BLUE}╚════════════════════════════════════════════════════╝{RESET}")
    print()
