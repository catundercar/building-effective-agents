...
LABS = [
    {
        "name": "Lab 1: LLM Client",
        "test_file": "tests/test_lab1_client.py",
        "source_file": "phase_0/client.py",
        "color": RED,
    },
    {
        "name": "Lab 2: Tool System",
        "test_file": "tests/test_lab2_tools.py",
        "source_file": "phase_0/tools.py",
        "color": YELLOW,
    },
    {
        "name": "Lab 3: Context Manager",
        "test_file": "tests/test_lab3_context.py",
        "source_file": "phase_0/context.py",
        "color": BLUE,
    },
]
...
def main():
    ...
    print(f"{BOLD}{CYAN}║      Phase 0: Augmented LLM Core — 評分     ║{RESET}")
    print(f"{BOLD}{CYAN}╚══════════════════════════════════════════════╝{RESET}")
    print()
