...
LABS = [
    {
        "name": "Lab 1: CLI Renderer",
        "test_file": "tests/test_lab1_cli_app.py",
        "source_file": "phase_5/cli_app.py",
        "color": RED,
    },
    {
        "name": "Lab 2: Config System",
        "test_file": "tests/test_lab2_config.py",
        "source_file": "phase_5/config.py",
        "color": YELLOW,
    },
    {
        "name": "Lab 3: Session Manager",
        "test_file": "tests/test_lab3_session.py",
        "source_file": "phase_5/session.py",
        "color": BLUE,
    },
]
...
def main():
    ...
    print(f"{BOLD}{CYAN}║        Phase 5: Ship It — 評分              ║{RESET}")
    print(f"{BOLD}{CYAN}╚══════════════════════════════════════════════╝{RESET}")
    print()
