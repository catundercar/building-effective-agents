...
LABS = [
    {
        "name": "Lab 1: Agent Loop",
        "test_file": "tests/test_lab1_agent_loop.py",
        "source_file": "phase_3/agent_loop.py",
        "color": RED,
    },
    {
        "name": "Lab 2: Error Recovery",
        "test_file": "tests/test_lab2_error_recovery.py",
        "source_file": "phase_3/error_recovery.py",
        "color": YELLOW,
    },
    {
        "name": "Lab 3: Permissions",
        "test_file": "tests/test_lab3_permissions.py",
        "source_file": "phase_3/permissions.py",
        "color": BLUE,
    },
]
...
def main():
    ...
    print(f"{BOLD}{PURPLE}║       Phase 3: Agentic Loop — 評分          ║{RESET}")
    print(f"{BOLD}{PURPLE}╚══════════════════════════════════════════════╝{RESET}")
    print()
